function [reg_corner,rho,eta,reg_param] = l_curve(U,sm,b,method,plotFlag,L,V)
...
npoints = 100000;  % Number of points on the L-curve for Tikh and dsvd.
...
if plotFlag
    ...
    disp("L-curve corner at "+num2str(reg_corner))
end